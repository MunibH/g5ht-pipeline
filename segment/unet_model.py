...
# model for segmenting the worm in NIR images (https://github.com/flavell-lab/private_unet2d/blob/main/unet2d/model/unet_model.py)
# best weights: /home/munib/code/g5ht-pipeline/segment/worm_segmentation_best_weights_3010.pt
